...
SELECT 
    ...
    COALESCE(Duration, (SELECT AVG(Duration) FROM [PortfolioProject_MarketingAnalytics].dbo.customer_journey)) AS Duration  -- Replaces missing durations with the average duration for the corresponding date
FROM 
    (
